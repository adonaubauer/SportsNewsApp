...
public class NflPlayerInfo {
    ...
    public NflPlayerInfo(String playerLastName, String playerFirstName, String playerPosition) {
    ...
    public String toString() {
        ...
        String nflPlayerInfoToString = teamCity + " " + teamName + " " + playerFirstName + " " + playerLastName + " " + playerPosition
                    + playerGamesPlayed + " " + playerPassingAttempts
